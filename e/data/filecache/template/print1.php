...
<title><?=htmlspecialchars($r[title])?> 打印页面 - Powered by EmpireCMS</title>
<meta name="keywords" content="<?=htmlspecialchars($r[title])?> 打印页面" />
<meta name="description" content="<?=htmlspecialchars($r[title])?> 打印页面" />
<style>
