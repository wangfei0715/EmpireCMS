...
<input name="playadmin" type="text" id="playadmin" value="<?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[playadmin]))?>">
  ...
  <tr> 
    ...
    <td bgcolor=ffffff>影片格式：<input name="filetype" type="text" size=8 id="filetype" value="<?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[filetype]))?>">
<select name="select2" onchange="document.add.filetype.value=this.value">
      ...
      </select>，影片大小：<input name="filesize" type="text" size=12 id="filesize" value="<?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[filesize]))?>">
<select name="select" onchange="document.add.filesize.value+=this.value">
  ...
  <tr> 
    ...
    <td bgcolor=ffffff>带宽要求：<input name="playdk" type="text" id="playdk" value="<?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[playdk]))?>">
，片长：
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td bgcolor=ffffff><textarea name="moviesay" cols="80" rows="10" id="moviesay"><?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[moviesay]))?></textarea>
</td>
  </tr>
</table>
