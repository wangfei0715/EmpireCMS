...
<select name="select" onchange="document.add.filesize.value+=this.value">
      ...
      </select></td></tr><tr><td bgcolor=ffffff>图片尺寸</td><td bgcolor=ffffff><input name="picsize" type="text" id="picsize" value="<?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[picsize]))?>">
</td></tr><tr><td bgcolor=ffffff>图片分辨率</td><td bgcolor=ffffff><input name="picfbl" type="text" id="picfbl" value="<?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[picfbl]))?>">
</td></tr><tr><td bgcolor=ffffff>来源</td><td bgcolor=ffffff><input name="picfrom" type="text" size=60 id="picfrom" value="<?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[picfrom]))?>">
...
</td></tr><tr><td bgcolor=ffffff>每行显示条数</td><td bgcolor=ffffff><input name="num" type="text" size=3 id="num" value="<?=$ecmsfirstpost==1?"3":htmlspecialchars(stripSlashes($r[num]))?>">
</td></tr><tr><td bgcolor=ffffff>缩图宽度</td><td bgcolor=ffffff><input name="width" type="text" size=6 id="width" value="<?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[width]))?>">
</td></tr><tr><td bgcolor=ffffff>缩图高度</td><td bgcolor=ffffff><input name="height" type="text" size=6 id="height" value="<?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[height]))?>">
</td></tr><tr><td bgcolor=ffffff>图片简介</td><td bgcolor=ffffff><textarea name="picsay" cols="80" rows="10" id="picsay"><?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[picsay]))?></textarea>
</td></tr>