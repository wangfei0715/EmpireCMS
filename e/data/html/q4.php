...
<input type="file" name="titlepicfile" size="45">
  ...
  <tr>
    ...
    <td bgcolor=ffffff><input name="flashwriter" type="text" size=42 id="flashwriter" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'flashwriter',stripSlashes($r[flashwriter]))?>">
</td>
  </tr>
  <tr>
    <td width=16% height=25 bgcolor=ffffff>作者邮箱</td>
    <td bgcolor=ffffff><input name="email" type="text" size=42 id="email" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'email',stripSlashes($r[email]))?>">
</td>
  </tr>
  <tr>
