...
</table></td></tr><tr><td bgcolor=ffffff>发布时间</td><td bgcolor=ffffff><input name="newstime" type="text" value="<?=$r[newstime]?>"><input type=button name=button value="设为当前时间" onclick="document.add.newstime.value='<?=$todaytime?>'"></td></tr><tr><td bgcolor=ffffff>影片缩略图</td><td bgcolor=ffffff>
...
</td></tr><tr><td bgcolor=ffffff>影片格式</td><td bgcolor=ffffff><input name="filetype" type="text" size=8 id="filetype" value="<?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[filetype]))?>">
<select name="select2" onchange="document.add.filetype.value=this.value">
      ...
      </select></td></tr><tr><td bgcolor=ffffff>影片大小</td><td bgcolor=ffffff><input name="filesize" type="text" size=12 id="filesize" value="<?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[filesize]))?>">
...
</td></tr><tr><td bgcolor=ffffff>影片简介</td><td bgcolor=ffffff><textarea name="moviesay" cols="80" rows="10" id="moviesay"><?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[moviesay]))?></textarea>
</td></tr>