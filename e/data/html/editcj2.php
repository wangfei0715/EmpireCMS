...
</table></td></tr><tr><td bgcolor=ffffff>发布时间</td><td bgcolor=ffffff><input name="newstime" type="text" value="<?=$r[newstime]?>"><input type=button name=button value="设为当前时间" onclick="document.add.newstime.value='<?=$todaytime?>'"></td></tr><tr><td bgcolor=ffffff>软件预览图</td><td bgcolor=ffffff>
...
</td></tr><tr><td bgcolor=ffffff>软件简介</td><td bgcolor=ffffff><textarea name="softsay" cols="80" rows="10" id="softsay"><?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[softsay]))?></textarea>
</td></tr>