...
<select name="select" onchange="document.add.filesize.value+=this.value">
  ...
  <tr> 
    ...
    <td bgcolor=ffffff>图片尺寸：<input name="picsize" type="text" id="picsize" value="<?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[picsize]))?>">
，图片分辨率：<input name="picfbl" type="text" id="picfbl" value="<?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[picfbl]))?>">
</td>
  </tr>
  <tr> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td bgcolor=ffffff>每行显示条数：<input name="num" type="text" size=3 id="num" value="<?=$ecmsfirstpost==1?"3":htmlspecialchars(stripSlashes($r[num]))?>">
，缩图大小：<input name="width" type="text" size=6 id="width" value="<?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[width]))?>">
