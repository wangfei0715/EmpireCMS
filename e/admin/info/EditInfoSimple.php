...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="tableborder">
  <form name="add" method="post" action="../ecmsinfo.php">
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td><input name="titlepic" type="text" id="titlepic" value="<?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[titlepic]))?>" size="45"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td height="25">置顶级别: 
        <select name="istop">
		  ...
		  <option value="8"<?=$r[istop]==9?' selected':''?>>九级置顶</option>
        </select>
        , 
