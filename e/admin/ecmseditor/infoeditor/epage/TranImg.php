...
<body scroll="no" style="overflow: hidden">
					...
					<table cellspacing="0" cellpadding="0" width="100%" border="0">
						<tr>
							...
							<td id="tdBrowse" style="display: none" nowrap="nowrap" rowspan="2">
								&nbsp;
								<input id="btnBrowse" onclick="window.open('<?="../../FileMain.php?filepass=$filepass&classid=$classid&type=1&InstanceName=$InstanceName&tranfrom=1&field=opener.document.etranimgform.inserturl";?>','','width=700,height=550,scrollbars=yes');" type="button" value="Browse Server" fcklang="DlgBtnBrowseServer" />
							</td>
						</tr>
						<tr>
							<td valign="top">
  ...
  <form id="frmUpload" name="TranImgFormT" method="post" target="UploadWindow" enctype="multipart/form-data" action="../../ecmseditor.php" onsubmit="return DoCheckTranFile(document.TranImgFormT);">
	...
	<tr> 
        <td>文件别名<br>
          <input name="no" type="text" id="no" value="<?=$_GET['fileno']?>" style="width: 100%">
        </td>
    </tr>
    <tr> 
        <td> 
