					...
					<td>
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								...
								<td id="tdBrowse" style="DISPLAY: none" noWrap rowSpan="2">&nbsp; <input id="btnBrowse" onclick="window.open('<?="../../FileMain.php?filepass=$filepass&classid=$classid&type=2&InstanceName=$InstanceName&tranfrom=1&field=opener.document.etranflashform.inserturl";?>','','width=700,height=550,scrollbars=yes');" type="button" value="Browse Server" fckLang="DlgBtnBrowseServer">
								</td>
							</tr>
							<tr>
