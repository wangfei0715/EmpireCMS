...
document.write( FCKTools.GetStyleHtml( GetCommonDialogCss() ) ) ;
		...
		function DoCheckTranFile(obj){
			...
			ctypes="<?=$mediaplayertype?>";
			ctypest="<?=$realplayertype?>";
...
function echoViewFile(obj,ecms){
	...
	var imgstr="";
	var autostart;
	var mediatypes="<?=$mediaplayertype?>";
	var realtypes="<?=$realplayertype?>";
	var furl,filetype;
        ...
        <td> <table cellSpacing="0" cellPadding="0" width="100%" border="0">
            <tr> 
              ...
              <td id="tdBrowse" style="DISPLAY: none" noWrap rowSpan="2">&nbsp; 
                <input id="btnBrowse" onclick="window.open('<?="../../FileMain.php?filepass=$filepass&classid=$classid&type=3&InstanceName=$InstanceName&tranfrom=1&field=opener.document.etranflashform.inserturl";?>','','width=700,height=550,scrollbars=yes');" type="button" value="Browse Server" fckLang="DlgBtnBrowseServer"> 
              </td>
            </tr>
            <tr> 
...
<div id="divUpload" style="DISPLAY: none"> 
  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" id="tranpictb">
    <form id="frmUpload" name="TranFlashFormT" method="post" target="UploadWindow" enctype="multipart/form-data" action="../../ecmseditor.php" onsubmit="return DoCheckTranFile(TranFlashFormT);">
      ...
      <tr> 
        <td>文件别名<br> <input name="no" type="text" id="no" value="<?=$_GET['fileno']?>" style="width: 100%"> 
        </td>
      </tr>
      <tr> 
