        ...
        <td> <table cellSpacing="1" cellPadding="1" width="100%" border="0">
            <tr> 
              ...
              <td id="tdBrowse" style="DISPLAY: none" noWrap rowSpan="2">&nbsp; 
                <input id="btnBrowse" onclick="window.open('<?="../../FileMain.php?filepass=$filepass&classid=$classid&type=0&InstanceName=$InstanceName&tranfrom=1&field=opener.document.etranfileform.inserturl";?>','','width=700,height=550,scrollbars=yes');" type="button" value="Browse Server" fckLang="DlgBtnBrowseServer"> 
              </td>
            </tr>
            <tr> 
