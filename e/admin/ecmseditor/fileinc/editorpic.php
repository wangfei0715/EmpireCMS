...
while($r=$empire->fetch($sql))
{
  ...
  <tr>
    <td valign='bottom'>
<div align='center'><a href='cropimg/CropImage.php?fileid=".$r[fileid]."&filepass=".$filepass."' target='_blank' title='裁剪'><img src='../../data/images/cropimg.gif' width='13' height='13' border='0'></a></div></td>
  </tr>
  <tr> 
